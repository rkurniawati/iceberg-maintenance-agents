...
from ..iceberg_knowledge import get_iceberg_knowledge_agent
...
def get_iceberg_database_info_agent() -> Agent:
    return Agent(
        ...
        sub_agents=[get_iceberg_knowledge_agent()],
        tools=[get_tables, get_table_schema, get_all_current_table_files, 
               find_orphan_files, get_manifest_files, get_snapshots, recall_user_preferences],
